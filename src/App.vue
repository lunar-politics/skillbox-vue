  ...
  computed: {
    filProducts() {
      ...
      if (this.filterPriceFrom > 0) {
        filProducts = filProducts.filter((product) => product.price > this.filterPriceFrom);
      }
    ...
    products() {
      ...
      return this.filProducts.slice(offset, offset + this.productsPerPage);
    },
    countProducts() {
      return this.filProducts.length;
    },
  },
};
</script>
